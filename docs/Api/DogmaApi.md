...
```php
getDogmaAttributes($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): int[]
```
...
try {
    $result = $apiInstance->getDogmaAttributes($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getDogmaAttributesAttributeId($attribute_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\DogmaAttributesAttributeIdGet
```
...
try {
    $result = $apiInstance->getDogmaAttributesAttributeId($attribute_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getDogmaDynamicItemsTypeIdItemId($item_id, $type_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\DogmaDynamicItemsTypeIdItemIdGet
```
...
try {
    $result = $apiInstance->getDogmaDynamicItemsTypeIdItemId($item_id, $type_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getDogmaEffects($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): int[]
```
...
try {
    $result = $apiInstance->getDogmaEffects($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getDogmaEffectsEffectId($effect_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\DogmaEffectsEffectIdGet
```
...
try {
    $result = $apiInstance->getDogmaEffectsEffectId($effect_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
