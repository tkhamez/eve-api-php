...
```php
getMetaChangelog($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\MetaChangelog
```
...
try {
    $result = $apiInstance->getMetaChangelog($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getMetaCompatibilityDates($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\MetaCompatibilityDates
```
...
try {
    $result = $apiInstance->getMetaCompatibilityDates($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getMetaStatus($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\MetaStatus
```
...
try {
    $result = $apiInstance->getMetaStatus($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MetaApi->getMetaStatus: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Tkhamez\Eve\API\Model\MetaStatus**](../Model/MetaStatus.md)
