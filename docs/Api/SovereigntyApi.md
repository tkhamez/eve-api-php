...
```php
getSovereigntyCampaigns($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\SovereigntyCampaignsGetInner[]
```
...
try {
    $result = $apiInstance->getSovereigntyCampaigns($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getSovereigntyMap($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\SovereigntyMapGetInner[]
```
...
try {
    $result = $apiInstance->getSovereigntyMap($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getSovereigntyStructures($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\SovereigntyStructuresGetInner[]
```
...
try {
    $result = $apiInstance->getSovereigntyStructures($accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
