...
```php
getWars($max_war_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): int[]
```
...
try {
    $result = $apiInstance->getWars($max_war_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getWarsWarId($war_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\WarsWarIdGet
```
...
try {
    $result = $apiInstance->getWarsWarId($war_id, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
...
```php
getWarsWarIdKillmails($war_id, $page, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since): \Tkhamez\Eve\API\Model\CharactersCharacterIdKillmailsRecentGetInner[]
```
...
try {
    $result = $apiInstance->getWarsWarIdKillmails($war_id, $page, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since);
    print_r($result);
} catch (Exception $e) {
