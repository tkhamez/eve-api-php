...
class SearchApi
{
     ...
     */
    public function getCharactersCharacterIdSearch($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-11-06', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        list($response) = $this->getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $strict, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $contentType);
        return $response;
    }
     ...
     */
    public function getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-11-06', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        $request = $this->getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $strict, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $contentType);
     ...
     */
    public function getCharactersCharacterIdSearchAsync($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-11-06', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        return $this->getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $strict, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-11-06', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     */
    public function getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-11-06', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
