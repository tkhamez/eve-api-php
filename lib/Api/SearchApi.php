...
class SearchApi
{
     ...
     */
    public function getCharactersCharacterIdSearch($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     */
    public function getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     */
    public function getCharactersCharacterIdSearchAsync($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     */
    public function getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
