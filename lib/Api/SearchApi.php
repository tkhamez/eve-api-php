...
class SearchApi
{
     ...
     */
    public function getCharactersCharacterIdSearch($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', $if_modified_since = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        list($response) = $this->getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $strict, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since, $contentType);
        return $response;
    }
     ...
     */
    public function getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', $if_modified_since = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        $request = $this->getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $strict, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since, $contentType);
     ...
     */
    public function getCharactersCharacterIdSearchAsync($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', $if_modified_since = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        return $this->getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $strict, $accept_language, $if_none_match, $x_compatibility_date, $x_tenant, $if_modified_since, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', $if_modified_since = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     */
    public function getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $strict = false, $accept_language = 'en', $if_none_match = null, $x_compatibility_date = '2025-12-16', $x_tenant = 'tranquility', $if_modified_since = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
