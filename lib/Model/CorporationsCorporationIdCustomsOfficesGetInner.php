...
class CorporationsCorporationIdCustomsOfficesGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int $reinforce_exit_start Together with reinforce_exit_end, marks a 2-hour or 6-hour (depending on the office type) period where this customs office could exit reinforcement mode during the day after initial attack
     *
     * @return self
     */
     ...
     * Sets type_id
     *
     * @param int|null $type_id ID of the type of this customs office
     *
     * @return self
     */
