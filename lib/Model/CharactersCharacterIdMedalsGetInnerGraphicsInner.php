...
/**
 * CharactersCharacterIdMedalsGetInnerGraphicsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class CharactersCharacterIdMedalsGetInnerGraphicsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdMedalsGet_inner_graphics_inner';
    ...
    */
    ...
    {
        if (is_null($graphic)) {
            throw new \InvalidArgumentException('non-nullable graphic cannot be null');
        }
