...
/**
 * PostCharactersCharacterIdFittingsRequest Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class PostCharactersCharacterIdFittingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostCharactersCharacterIdFittings_request';
    ...
    protected static $openAPITypes = [
        'description' => 'string',
        'items' => '\Tkhamez\Eve\API\Model\PostCharactersCharacterIdFittingsRequestItemsInner[]',
        'name' => 'string',
        'ship_type_id' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \Tkhamez\Eve\API\Model\PostCharactersCharacterIdFittingsRequestItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Tkhamez\Eve\API\Model\PostCharactersCharacterIdFittingsRequestItemsInner[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 512)) {
            throw new \InvalidArgumentException('invalid value for $items when calling PostCharactersCharacterIdFittingsRequest., number of items must be less than or equal to 512.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling PostCharactersCharacterIdFittingsRequest., number of items must be greater than or equal to 1.');
        }
