...
/**
 * CharactersCharacterIdFittingsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdFittingsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdFittingsGet_inner';
    ...
    protected static $openAPITypes = [
        'description' => 'string',
        'fitting_id' => 'int',
        'items' => '\Tkhamez\Eve\API\Model\CharactersCharacterIdFittingsGetInnerItemsInner[]',
        'name' => 'string',
        'ship_type_id' => 'int'
    ];
    ...
    */
     ...
     * Sets fitting_id
     *
     * @param int $fitting_id fitting_id
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Tkhamez\Eve\API\Model\CharactersCharacterIdFittingsGetInnerItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Tkhamez\Eve\API\Model\CharactersCharacterIdFittingsGetInnerItemsInner[] $items items
     *
     * @return self
     */
