...
/**
 * UniverseSystemJumpsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class UniverseSystemJumpsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniverseSystemJumpsGet_inner';
    ...
    {
        $this->setIfExists('ship_jumps', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ship_jumps'] === null) {
            $invalidProperties[] = "'ship_jumps' can't be null";
        }
     ...
     * Sets ship_jumps
     *
     * @param int $ship_jumps ship_jumps
     *
     * @return self
     */
    public function setShipJumps($ship_jumps)
    {
        if (is_null($ship_jumps)) {
            throw new \InvalidArgumentException('non-nullable ship_jumps cannot be null');
        }
