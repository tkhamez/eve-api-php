...
/**
 * CharactersCharacterIdNotificationsContactsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdNotificationsContactsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdNotificationsContactsGet_inner';
    ...
    protected static $openAPIFormats = [
        ...
        'send_date' => 'date-time',
        'sender_character_id' => 'int64',
        'standing_level' => 'double'
    ];
    ...
    */
     ...
     *
     * @param int $sender_character_id sender_character_id
     *
     * @return self
     */
