...
/**
 * FreelanceJobsDetailRestrictions Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class FreelanceJobsDetailRestrictions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreelanceJobsDetailRestrictions';
    ...
    */
     ...
     * Sets maximum_age
     *
     * @param int|null $maximum_age Maximum age of the participant, in days
     *
     * @return self
     */
     ...
     * Sets minimum_age
     *
     * @param int|null $minimum_age Minimum age of the participant, in days
     *
     * @return self
     */
