...
/**
 * UniverseSystemKillsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class UniverseSystemKillsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniverseSystemKillsGet_inner';
    ...
    {
        $this->setIfExists('npc_kills', $data ?? [], null);
        $this->setIfExists('pod_kills', $data ?? [], null);
        $this->setIfExists('ship_kills', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($npc_kills)) {
            throw new \InvalidArgumentException('non-nullable npc_kills cannot be null');
        }
    ...
    {
        if (is_null($pod_kills)) {
            throw new \InvalidArgumentException('non-nullable pod_kills cannot be null');
        }
    ...
    {
        if (is_null($ship_kills)) {
            throw new \InvalidArgumentException('non-nullable ship_kills cannot be null');
        }
