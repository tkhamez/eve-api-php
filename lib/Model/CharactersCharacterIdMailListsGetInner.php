...
/**
 * CharactersCharacterIdMailListsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdMailListsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdMailListsGet_inner';
    ...
    {
        $this->setIfExists('mailing_list_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($mailing_list_id)) {
            throw new \InvalidArgumentException('non-nullable mailing_list_id cannot be null');
        }
