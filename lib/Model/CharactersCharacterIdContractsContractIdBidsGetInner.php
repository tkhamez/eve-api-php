...
/**
 * CharactersCharacterIdContractsContractIdBidsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdContractsContractIdBidsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdContractsContractIdBidsGet_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bidder_id', $data ?? [], null);
        $this->setIfExists('date_bid', $data ?? [], null);
    }
    ...
    */
    ...
    public function setBidderId($bidder_id)
    {
        if (is_null($bidder_id)) {
            throw new \InvalidArgumentException('non-nullable bidder_id cannot be null');
        }
    ...
    {
        if (is_null($date_bid)) {
            throw new \InvalidArgumentException('non-nullable date_bid cannot be null');
        }
