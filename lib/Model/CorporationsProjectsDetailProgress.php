...
/**
 * CorporationsProjectsDetailProgress Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CorporationsProjectsDetailProgress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CorporationsProjectsDetailProgress';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('desired', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets desired
     *
     * @param int $desired Desired progress
     *
     * @return self
     */
    ...
    {
        if (is_null($desired)) {
            throw new \InvalidArgumentException('non-nullable desired cannot be null');
        }
