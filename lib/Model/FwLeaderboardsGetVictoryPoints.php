...
/**
 * FwLeaderboardsGetVictoryPoints Class Doc Comment
 *
 * @category Class
 ...
 */
class FwLeaderboardsGetVictoryPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FwLeaderboardsGet_victory_points';
    ...
    protected static $openAPITypes = [
        'active_total' => '\Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsActiveTotalInner[]',
        'last_week' => '\Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsLastWeekInner[]',
        'yesterday' => '\Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsYesterdayInner[]'
    ];
    ...
    */
     ...
     * Gets active_total
     *
     * @return \Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsActiveTotalInner[]
     */
     ...
     * Sets active_total
     *
     * @param \Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsActiveTotalInner[] $active_total Top 4 ranking of factions active in faction warfare by total victory points. A faction is considered \"active\" if they have participated in faction warfare in the past 14 days
     *
     * @return self
     */
     ...
     * Gets last_week
     *
     * @return \Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsLastWeekInner[]
     */
     ...
     * Sets last_week
     *
     * @param \Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsLastWeekInner[] $last_week Top 4 ranking of factions by victory points in the past week
     *
     * @return self
     */
     ...
     * Gets yesterday
     *
     * @return \Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsYesterdayInner[]
     */
     ...
     * Sets yesterday
     *
     * @param \Tkhamez\Eve\API\Model\FwLeaderboardsGetVictoryPointsYesterdayInner[] $yesterday Top 4 ranking of factions by victory points in the past day
     *
     * @return self
     */
