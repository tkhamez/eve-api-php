...
/**
 * IncursionsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class IncursionsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncursionsGet_inner';
    ...
    protected static $openAPIFormats = [
        ...
        'faction_id' => 'int64',
        'has_boss' => null,
        'infested_solar_systems' => 'int64',
        'influence' => 'double',
        'staging_solar_system_id' => 'int64',
        'state' => null,
        'type' => null
    ];
