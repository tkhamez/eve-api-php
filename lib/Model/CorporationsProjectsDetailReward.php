...
/**
 * CorporationsProjectsDetailReward Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CorporationsProjectsDetailReward implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CorporationsProjectsDetailReward';
    ...
    */
     ...
     * Sets initial
     *
     * @param float $initial Original amount of ISK that was reserved for this project
     *
     * @return self
     */
     ...
     * Sets remaining
     *
     * @param float $remaining Remaining ISK to be awarded
     *
     * @return self
     */
