...
/**
 * FreelanceJobsDetailParametermatchervalue Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class FreelanceJobsDetailParametermatchervalue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreelanceJobsDetailParametermatchervalue';
    ...
    */
     ...
     * Sets value_type
     *
     * @param string $value_type Type of the value(s)
     *
     * @return self
     */
     ...
     * Sets values
     *
     * @param string[] $values Value(s) of this type
     *
     * @return self
     */
