...
/**
 * PostCharactersCharacterIdMailRequest Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class PostCharactersCharacterIdMailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostCharactersCharacterIdMail_request';
    ...
    */
     ...
     * Sets approved_cost
     *
     * @param int|null $approved_cost approved_cost
     *
     * @return self
     */
     ...
     * Gets recipients
     *
     * @return \Tkhamez\Eve\API\Model\PostCharactersCharacterIdMailRequestRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \Tkhamez\Eve\API\Model\PostCharactersCharacterIdMailRequestRecipientsInner[] $recipients recipients
     *
     * @return self
     */
    public function setRecipients($recipients)
    {
        ...
        if ((count($recipients) > 50)) {
            throw new \InvalidArgumentException('invalid value for $recipients when calling PostCharactersCharacterIdMailRequest., number of items must be less than or equal to 50.');
        }
        if ((count($recipients) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipients when calling PostCharactersCharacterIdMailRequest., number of items must be greater than or equal to 1.');
        }
