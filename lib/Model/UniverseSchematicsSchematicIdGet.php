...
/**
 * UniverseSchematicsSchematicIdGet Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class UniverseSchematicsSchematicIdGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniverseSchematicsSchematicIdGet';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('schematic_name', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets schematic_name
     *
     * @param string $schematic_name schematic_name
     *
     * @return self
     */
    public function setSchematicName($schematic_name)
    {
        if (is_null($schematic_name)) {
            throw new \InvalidArgumentException('non-nullable schematic_name cannot be null');
        }
