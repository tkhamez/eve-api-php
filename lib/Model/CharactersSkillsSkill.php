...
/**
 * CharactersSkillsSkill Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersSkillsSkill implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersSkillsSkill';
    ...
    protected static $openAPIFormats = [
        'active_skill_level' => 'int64',
        'skill_id' => 'int64',
        'skillpoints_in_skill' => 'int64',
        'trained_skill_level' => 'int64'
    ];
    ...
    */
     ...
     *
     * @param int $active_skill_level The active skill level (can differ from trained due to alpha status and/or active expert systems)
     *
     * @return self
     */
     ...
     * Sets skill_id
     *
     * @param int $skill_id The Type ID of the skill
     *
     * @return self
     */
     ...
     *
     * @param int $skillpoints_in_skill The amount of Skill Points in the skill
     *
     * @return self
     */
     ...
     *
     * @param int $trained_skill_level The trained skill level
     *
     * @return self
     */
