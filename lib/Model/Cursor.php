...
class Cursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets after
     *
     * @param string|null $after Cursor to use as 'after' in your next request, to continue walking forwards in time.
     *
     * @return self
     */
     ...
     * Sets before
     *
     * @param string|null $before Cursor to use as 'before' in your next request, to continue walking backwards in time.
     *
     * @return self
     */
