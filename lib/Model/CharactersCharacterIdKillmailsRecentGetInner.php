...
/**
 * CharactersCharacterIdKillmailsRecentGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdKillmailsRecentGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdKillmailsRecentGet_inner';
    ...
    {
        $this->setIfExists('killmail_hash', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['killmail_hash'] === null) {
            $invalidProperties[] = "'killmail_hash' can't be null";
        }
    ...
    {
        if (is_null($killmail_hash)) {
            throw new \InvalidArgumentException('non-nullable killmail_hash cannot be null');
        }
