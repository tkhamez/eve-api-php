...
/**
 * PostUiOpenwindowNewmailRequest Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class PostUiOpenwindowNewmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostUiOpenwindowNewmail_request';
    ...
    protected static $openAPIFormats = [
        ...
        'recipients' => 'int64',
        'subject' => null,
        'to_corp_or_alliance_id' => 'int64',
        'to_mailing_list_id' => 'int64'
    ];
    ...
    */
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $body when calling PostUiOpenwindowNewmailRequest., must be smaller than or equal to 10000.');
        }
    ...
    public function setRecipients($recipients)
    {
        ...
        if ((count($recipients) > 50)) {
            throw new \InvalidArgumentException('invalid value for $recipients when calling PostUiOpenwindowNewmailRequest., number of items must be less than or equal to 50.');
        }
        if ((count($recipients) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipients when calling PostUiOpenwindowNewmailRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling PostUiOpenwindowNewmailRequest., must be smaller than or equal to 1000.');
        }
     ...
     *
     * @param int|null $to_corp_or_alliance_id to_corp_or_alliance_id
     *
     * @return self
     */
