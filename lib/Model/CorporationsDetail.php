...
/**
 * CorporationsDetail Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CorporationsDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CorporationsDetail';
     ...
     * Sets alliance_id
     *
     * @param int|null $alliance_id Corporation's alliance ID
     *
     * @return self
     */
     ...
     * Sets ceo_id
     *
     * @param int $ceo_id Corporation's CEO ID
     *
     * @return self
     */
     ...
     * Sets creator_id
     *
     * @param int $creator_id Corporation's creator ID
     *
     * @return self
     */
     ...
     * Sets date_founded
     *
     * @param \DateTime|null $date_founded Corporation's founding date
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Corporation's description
     *
     * @return self
     */
     ...
     * Sets faction_id
     *
     * @param int|null $faction_id Corporation's faction ID
     *
     * @return self
     */
     ...
     *
     * @param int|null $home_station_id Corporation's home station ID
     *
     * @return self
     */
     ...
     * Sets member_count
     *
     * @param int $member_count Corporation's member count
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Corporation's name
     *
     * @return self
     */
     ...
     * Sets shares
     *
     * @param int|null $shares Corporation's shares
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param float $tax_rate Corporation's tax rate
     *
     * @return self
     */
     ...
     * Sets ticker
     *
     * @param string $ticker Corporation's short name
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Corporation's URL
     *
     * @return self
     */
     ...
     * Sets war_eligible
     *
     * @param bool|null $war_eligible Corporation's war eligible
     *
     * @return self
     */
