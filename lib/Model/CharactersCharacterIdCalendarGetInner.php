...
/**
 * CharactersCharacterIdCalendarGetInner Class Doc Comment
 *
 * @category Class
 * @description event
 * @package  Tkhamez\Eve\API
 ...
 */
class CharactersCharacterIdCalendarGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdCalendarGet_inner';
