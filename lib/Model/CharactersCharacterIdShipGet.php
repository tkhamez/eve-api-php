...
/**
 * CharactersCharacterIdShipGet Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdShipGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdShipGet';
    ...
    {
        $this->setIfExists('ship_item_id', $data ?? [], null);
        $this->setIfExists('ship_name', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($ship_item_id)) {
            throw new \InvalidArgumentException('non-nullable ship_item_id cannot be null');
        }
     ...
     * Sets ship_name
     *
     * @param string $ship_name ship_name
     *
     * @return self
     */
    public function setShipName($ship_name)
    {
        if (is_null($ship_name)) {
            throw new \InvalidArgumentException('non-nullable ship_name cannot be null');
        }
