...
/**
 * CharactersSkillqueueSkill Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersSkillqueueSkill implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CharactersSkillqueueSkill';
    ...
    protected static $openAPIFormats = [
        ...
        'finished_level' => 'int64',
        'level_end_sp' => 'int64',
        'level_start_sp' => 'int64',
        'queue_position' => 'int64',
        'skill_id' => 'int64',
        'start_date' => 'date-time',
        'training_start_sp' => 'int64'
    ];
     ...
     * Sets finish_date
     *
     * @param \DateTime|null $finish_date The date the skill training will finish
     *
     * @return self
     */
     ...
     * Sets finished_level
     *
     * @param int $finished_level The level the skill is training for
     *
     * @return self
     */
     ...
     * Sets level_end_sp
     *
     * @param int|null $level_end_sp The Skill Points at the end of the level
     *
     * @return self
     */
     ...
     * Sets level_start_sp
     *
     * @param int|null $level_start_sp The Skill Points at the start of the level
     *
     * @return self
     */
     ...
     * Sets queue_position
     *
     * @param int $queue_position The position of the skill in the queue
     *
     * @return self
     */
     ...
     * Sets skill_id
     *
     * @param int $skill_id The TypeID of the skill
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date The date the skill training will start/continue
     *
     * @return self
     */
     ...
     *
     * @param int|null $training_start_sp The Skill Points at the start of training
     *
     * @return self
     */
