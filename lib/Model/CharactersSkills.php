...
/**
 * CharactersSkills Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersSkills implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersSkills';
    ...
    protected static $openAPITypes = [
        'skills' => '\Tkhamez\Eve\API\Model\CharactersSkillsSkill[]',
        'total_sp' => 'int',
        'unallocated_sp' => 'int'
    ];
    ...
    */
     ...
     * Gets skills
     *
     * @return \Tkhamez\Eve\API\Model\CharactersSkillsSkill[]
     */
     ...
     * Sets skills
     *
     * @param \Tkhamez\Eve\API\Model\CharactersSkillsSkill[] $skills The trained skills
     *
     * @return self
     */
     ...
     * Sets total_sp
     *
     * @param int $total_sp The total Skill Points spent on skills
     *
     * @return self
     */
     ...
     * Sets unallocated_sp
     *
     * @param int|null $unallocated_sp The amount of unallocated Skill Points
     *
     * @return self
     */
