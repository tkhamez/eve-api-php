...
/**
 * CorporationsCorporationIdContainersLogsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CorporationsCorporationIdContainersLogsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CorporationsCorporationIdContainersLogsGet_inner';
    ...
    protected static $openAPIFormats = [
        ...
        'character_id' => 'int64',
        'container_id' => 'int64',
        'container_type_id' => 'int64',
        'location_flag' => null,
        'location_id' => 'int64',
        'logged_at' => 'date-time',
        'new_config_bitmask' => 'int64',
        'old_config_bitmask' => 'int64',
        'password_type' => null,
        'quantity' => 'int64',
        'type_id' => 'int64'
    ];
    ...
    public const LOCATION_FLAG_EXPEDITION_HOLD = 'ExpeditionHold';
    ...
    public function getLocationFlagAllowableValues()
    {
        return [
            ...
            self::LOCATION_FLAG_EXPEDITION_HOLD,
    ...
    */
     ...
     * Sets location_flag
     *
     * @param string $location_flag location_flag
     *
     * @return self
     */
     ...
     *
     * @param int|null $new_config_bitmask new_config_bitmask
     *
     * @return self
     */
     ...
     *
     * @param int|null $old_config_bitmask old_config_bitmask
     *
     * @return self
     */
