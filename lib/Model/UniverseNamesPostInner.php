...
/**
 * UniverseNamesPostInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class UniverseNamesPostInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniverseNamesPost_inner';
    ...
    public const CATEGORY_ALLIANCE = 'alliance';
    public const CATEGORY_CHARACTER = 'character';
    public const CATEGORY_CONSTELLATION = 'constellation';
    public const CATEGORY_CORPORATION = 'corporation';
    public const CATEGORY_INVENTORY_TYPE = 'inventory_type';
