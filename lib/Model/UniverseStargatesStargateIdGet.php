...
/**
 * UniverseStargatesStargateIdGet Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class UniverseStargatesStargateIdGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniverseStargatesStargateIdGet';
    ...
    protected static $openAPITypes = [
        'destination' => '\Tkhamez\Eve\API\Model\UniverseStargatesStargateIdGetDestination',
        'name' => 'string',
    ...
    */
     ...
     * Gets destination
     *
     * @return \Tkhamez\Eve\API\Model\UniverseStargatesStargateIdGetDestination
     */
     ...
     * Sets destination
     *
     * @param \Tkhamez\Eve\API\Model\UniverseStargatesStargateIdGetDestination $destination destination
     *
     * @return self
     */
     ...
     * Sets stargate_id
     *
     * @param int $stargate_id stargate_id
     *
     * @return self
     */
