...
/**
 * WarsWarIdGetDefender Class Doc Comment
 *
 * @category Class
 ...
 */
class WarsWarIdGetDefender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarsWarIdGet_defender';
    ...
    */
     ...
     * Sets alliance_id
     *
     * @param int|null $alliance_id Alliance ID if and only if the defender is an alliance
     *
     * @return self
     */
     ...
     * Sets corporation_id
     *
     * @param int|null $corporation_id Corporation ID if and only if the defender is a corporation
     *
     * @return self
     */
