...
/**
 * CharactersCharacterIdFatigueGet Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class CharactersCharacterIdFatigueGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CharactersCharacterIdFatigueGet';
    ...
    protected static array $openAPINullables = [
        'jump_fatigue_expire_date' => false,
        'last_jump_date' => false,
    ...
    {
        $this->setIfExists('jump_fatigue_expire_date', $data ?? [], null);
        $this->setIfExists('last_jump_date', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DateTime|null $jump_fatigue_expire_date Character's jump fatigue expiry
     *
     * @return self
     */
    public function setJumpFatigueExpireDate($jump_fatigue_expire_date)
    {
        if (is_null($jump_fatigue_expire_date)) {
            throw new \InvalidArgumentException('non-nullable jump_fatigue_expire_date cannot be null');
        }
     ...
     * Sets last_jump_date
     *
     * @param \DateTime|null $last_jump_date Character's last jump activation
     *
     * @return self
     */
    public function setLastJumpDate($last_jump_date)
    {
        if (is_null($last_jump_date)) {
            throw new \InvalidArgumentException('non-nullable last_jump_date cannot be null');
        }
     ...
     *
     * @param \DateTime|null $last_update_date Character's last jump update
     *
     * @return self
     */
