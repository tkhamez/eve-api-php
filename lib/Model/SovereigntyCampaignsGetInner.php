...
/**
 * SovereigntyCampaignsGetInner Class Doc Comment
 *
 * @category Class
 * @package  Tkhamez\Eve\API
 * @author   OpenAPI Generator team
 ...
 */
class SovereigntyCampaignsGetInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SovereigntyCampaignsGet_inner';
    ...
    protected static $openAPITypes = [
        ...
        'event_type' => 'string',
        'participants' => '\Tkhamez\Eve\API\Model\SovereigntyCampaignsGetInnerParticipantsInner[]',
        'solar_system_id' => 'int',
        'start_time' => '\DateTime',
        'structure_id' => 'int'
    ];
    ...
    */
     ...
     * Gets participants
     *
     * @return \Tkhamez\Eve\API\Model\SovereigntyCampaignsGetInnerParticipantsInner[]|null
     */
     ...
     * Sets participants
     *
     * @param \Tkhamez\Eve\API\Model\SovereigntyCampaignsGetInnerParticipantsInner[]|null $participants Alliance participating and their respective scores, only present in Freeport Events.
     *
     * @return self
     */
